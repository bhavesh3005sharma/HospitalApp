...
public class ModelBookAppointment implements Serializable {
    ...
    public ModelBookAppointment(String patientName, String doctorName, String hospitalName, String disease, String age, String date , String status, String serialNumber, String doctorId, String hospitalId, String selectedTime, long thresholdLimit) {
